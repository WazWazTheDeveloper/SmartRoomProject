...
void loop() {
  ...
  // uint16_t rawData[99] = { 4330, 4420, 530, 1670, 480, 570, 530, 1670, 530, 1670, 480, 570, 530, 570, 530, 1670, 480, 570, 530, 570, 530, 1720, 480, 570, 480, 620, 480, 1720, 480, 1670, 480, 620, 480, 1720, 480, 1670, 480, 620, 480, 1720, 480, 1670, 480, 1720, 480, 1670, 480, 1720, 480, 1670, 530, 570, 480, 1720, 480, 570, 530, 570, 530, 570, 480, 620, 480, 570, 530, 570, 530, 1720, 480, 1670, 480, 570, 530, 1670, 530, 570, 480, 620, 480, 570, 530, 570, 530, 570, 530, 570, 530, 1670, 480, 570, 530, 1720, 480, 1670, 480, 1720, 480, 1670, 480 };  // Protocol=Samsung48 Address=0xB24D Command=0xBFD Raw-Data=0xF40B 48 bits LSB first
  // IrSender.sendRaw(rawData, sizeof(rawData) / sizeof(rawData[0]), NEC_KHZ);

  // IrSender.sendSamsung48(0xB24D, 0xBFD, 1);
  // delay(1000);
}